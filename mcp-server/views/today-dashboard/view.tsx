...
import { WidgetLoading, WidgetError, Kicker, ghostButtonStyle, primaryButtonStyle } from "../lib/ui";
import { WidgetFonts } from "../lib/fonts";
import type { TodayDashboardProps as Props } from "../../src/views/today-dashboard.schema";
    ...
    <>
      ...
      <div style={{ padding: 16, backgroundColor: bg, color: textColor, fontFamily: FONT, maxWidth: 480 }}>
        ...
        <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
          ...
          <button
            onClick={() => void sendFollowUp({ prompt: "Registra mi comida — describe lo que comí o comparte una foto" })}
            style={ghostButtonStyle(c, { flex: true })}
          >
            Registrar comida
          </button>
          <button
            onClick={() => void sendFollowUp({ prompt: "Dame recomendaciones para completar mis metas de nutrición y entrenamiento de hoy" })}
