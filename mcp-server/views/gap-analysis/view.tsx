...
import { WidgetLoading, WidgetError, Kicker, DisplayTitle, primaryButtonStyle } from "../lib/ui";
import { WidgetFonts } from "../lib/fonts";
import type { GapAnalysisProps as Props } from "../../src/views/gap-analysis.schema";
    ...
    return (
      <>
        ...
        <div style={{ padding: 16, backgroundColor: c.bg, color: c.text, fontFamily: FONT, maxWidth: 420 }}>
          ...
          <button
            onClick={() => void sendFollowUp({ prompt: "Revisa mi fase y programa actual — algo no cuadra en el análisis de constancia" })}
  ...
  return (
    <>
      ...
      <div style={{ padding: 16, backgroundColor: c.bg, color: c.text, fontFamily: FONT, maxWidth: 420 }}>
        ...
        {/* Follow-up button */}
        <button
          onClick={() => void sendFollowUp({ prompt: "Ayúdame a recuperar el ritmo: ¿qué debo hacer esta semana para ponerme al día con mi programa?" })}
          style={{ ...primaryButtonStyle(c), width: "100%" }}
        >
