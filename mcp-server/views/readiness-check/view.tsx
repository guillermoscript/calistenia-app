...
import type { ReadinessCheckProps as Props } from "../../src/views/readiness-check.schema";
  ...
  return (
    <>
      ...
      <div style={{ padding: 16, backgroundColor: c.bg, color: c.text, fontFamily: FONT, maxWidth: 420 }}>
        ...
        {/* Follow-up button */}
        <button
          onClick={() => void sendFollowUp({ prompt: "¿Qué entreno hoy? Usa cal_todays_workout para mostrarme el entrenamiento del día" })}
