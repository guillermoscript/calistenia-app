...
import { WidgetLoading, WidgetError, Kicker, DisplayTitle, primaryButtonStyle, ghostButtonStyle } from "../lib/ui";
import { WidgetFonts } from "../lib/fonts";
import type { ExerciseHistoryProps as Props } from "../../src/views/exercise-history.schema";
      ...
      >
        ...
        <div style={{ display: "flex", gap: 6 }}>
          <button
            onClick={() =>
              void sendFollowUp({
                prompt: `¿Estoy listo para progresar en ${displayName}? Usa cal_check_progression_readiness con exercise_id "${exercise_id}"`,
              })
            }
          ...
          <button
            onClick={() =>
              void sendFollowUp({
                prompt: `Analiza mi historial de ${displayName} y dame 2-3 recomendaciones concretas para mejorar`,
              })
            }
