...
import { WidgetLoading, WidgetError, Kicker, ghostButtonStyle } from "../lib/ui";
import { WidgetFonts } from "../lib/fonts";
import type { CircuitResultProps as Props } from "../../src/views/circuit-result.schema";
  ...
  return (
    <>
      ...
      <div style={{ padding: 16, backgroundColor: c.bg, color: c.text, fontFamily: FONT, maxWidth: 480 }}>
        ...
        {/* ── Follow-up button ── */}
        <button
          onClick={() => void sendFollowUp({ prompt: "Ver mis estadísticas de circuitos con cal_circuit_stats" })}
