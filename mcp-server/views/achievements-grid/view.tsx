...
import type { AchievementsGridProps as Props } from "../../src/views/achievements-grid.schema";
    ...
    <>
      ...
      <div style={{ padding: 16, backgroundColor: c.bg, color: c.text, fontFamily: FONT, maxWidth: 480 }}>
        ...
        <div style={{ marginTop: 14 }}>
          <button
            onClick={() => void sendFollowUp({ prompt: "¿Cómo desbloqueo los logros que me faltan? Dame un plan específico según mi progreso actual" })}
