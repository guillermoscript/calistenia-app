...
import type { SavedRecipesProps as Props } from "../../src/views/saved-recipes.schema";
    ...
    <>
      ...
      <div style={{ padding: 16, backgroundColor: c.bg, color: c.text, fontFamily: FONT, maxWidth: 520 }}>
          ...
          return (
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                ...
                <button
                  onClick={() => void sendFollowUp({ prompt: `Quiero cocinar mi receta guardada "${r.label}" hoy. ¿Tengo todo en la despensa?` })}
        ...
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
          <button
            onClick={() => void sendFollowUp({ prompt: "Genera un plan del día desde mi despensa para descubrir recetas nuevas." })}
