...
import type { TrendsChartProps as Props } from "../../src/views/trends-chart.schema";
    ...
    <>
      ...
      <div style={{ padding: 16, backgroundColor: bg, color: textColor, fontFamily: FONT, maxWidth: 480 }}>
        ...
        <div style={{ display: "flex", gap: 6, marginTop: 12 }}>
          <button
            onClick={() => void sendFollowUp({ prompt: "Compara este periodo con el anterior usando cal_compare_periods" })}
            style={ghostButtonStyle(c, { flex: true })}
          >
            Comparar periodos
          </button>
          <button
            onClick={() => void sendFollowUp({ prompt: "Analiza mis tendencias y dame 3 recomendaciones accionables" })}
            style={ghostButtonStyle(c, { flex: true })}
          >
            Analizar
          </button>
