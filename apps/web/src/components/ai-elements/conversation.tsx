...
type ConversationMessagePart = { type: string; text?: string };
...
type FormatMessage = (message: ConversationMessage, index: number) => string;
...
export const messagesToMarkdown = (
  ...
  formatMessage: FormatMessage = defaultFormatMessage
