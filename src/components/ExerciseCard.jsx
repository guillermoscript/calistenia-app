...
const PRIORITY_TEXT   = { high: 'text-red-500', med: 'text-amber-400', low: 'text-sky-500' }
const PRIORITY_LABELS = { high: 'PRIORITARIO', med: 'IMPORTANTE', low: 'COMPLEMENTARIO' }

export default function ExerciseCard({ exercise, workoutKey, onLogSet, onStartRest, logs = [] }) {
  ...
  const isComplete = totalSets !== '∞' && setsLogged >= parseInt(totalSets)
