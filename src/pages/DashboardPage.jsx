...
function StatCard({ value, label, sub, accent = 'text-lime' }) {
  return (
    <Card>
...
export default function DashboardPage({
  ...
  const daysElapsed = Math.floor((new Date() - startDate) / 86400000)
    ...
    <div className="max-w-5xl mx-auto px-4 md:px-6 py-6 md:py-8">
      ...
      {showProgramModal && (
        <ProgramSelectorModal
          ...
          onSelect={async (id) => { await onSelectProgram(id); setShowProgramModal(false) }}
